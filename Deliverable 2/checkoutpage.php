...
<body>
    ...
    <div class="row">
        <div class="col-12 col-md-6">
            ...
            <form id="deliveryForm" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
            ...
            <h4 style="color: white;"><strong>Grand Total:</strong> R<?php echo $_SESSION['buyer']->getCartTotal() * (1 + $_ENV['SERVICE_FEE']) + $deliveryFee ?> </h4>
