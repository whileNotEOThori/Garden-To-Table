            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link fs-6" id="header-nav-link" href="homepage.php#about">About Us</a></li>
                        <li class="nav-item"><a class="nav-link fs-6" id="header-nav-link" href="homepage.php#faq">FAQ</a></li>
                        <li class="nav-item"><a class="nav-link fs-6" id="header-nav-link" href="homepage.php#contact">Contact Us</a></li>
