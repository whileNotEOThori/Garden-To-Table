            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link fs-6 position-relative" id="header-nav-link" href=""><i class="bi bi-cart4 h3"></i><span class="position-absolute top-10 start-60 translate-middle badge rounded-pill bg-success"><?php echo ($_SESSION['cart'] == null) ? 0 : count($_SESSION['cart']) ?></span></a></li>
                    </ul>
                </div>
            </div>
        </nav>
